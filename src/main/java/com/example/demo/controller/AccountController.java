...
public class AccountController {
    ...
    public String accountModify(@PathVariable("id") Integer id, Model model){
    ...
    public String accountUpdate(@PathVariable("id") Integer id, Account account) throws IOException {
        //기존에있던글이 담겨져서온다.
